...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/icon-font.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/material-design-iconic-font.min.css">
...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('<?php echo base_url(); ?>images/bg-01.jpg');"></div>

			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" method="post" action="<?php base_url();?>logdata.html">
					...
					<div class="container-login100-form-btn">
						...
						<a href="<?php base_url();?>login.html" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Sign in
